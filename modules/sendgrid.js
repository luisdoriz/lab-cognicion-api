...
const sendEmailTest = async (email, url) => {
  html = getHtmlTemplate(url, "test");
  text = "Tiene un ejercicio por realizar.";
  await sendEmail(email, text, html);
};

const sendEmailSurvey = async (email, url) => {
  html = getHtmlTemplate(url, "survey");
  text = "Tiene un cuestionario por realizar.";
  await sendEmail(email, text, html);
};

const getHtmlTemplate = (url, type) => {
  template = `
  <!doctype html>
<html>
  <head>
              ...
              <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                <tr>
                  <td class="content-block" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;">
                    <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">UDEM</span>
                  </td>
                </tr>
              </table>
            </div>
